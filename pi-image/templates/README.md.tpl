...
- `player-update-check.sh`, `cms-player-updater.service` - Update auf Abruf:
  wird gestartet, sobald im CMS unter Mandant/Geraete fuer dieses Geraet ein
  Update angestossen wird, und installiert die neue Player-Version
  selbststaendig (Geraete-Registrierung, WLAN- und Branding-Einstellungen
  bleiben dabei unangetastet) - kein manuelles Neu-Bereitstellen fuer zukuenftige
